...
docker compose up -d --force-recreate openclaw-gateway openclaw-cli trello-bridge github-pr-bridge gmail-hook-bridge trello-gateway trello-queue-worker trello-routines
